...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/BenWolfaardt/checkers/leaderboard/leaderboard
   */
  queryLeaderboard = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetLeaderboardResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/leaderboard/leaderboard`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/BenWolfaardt/checkers/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
